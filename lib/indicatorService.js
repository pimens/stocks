...
class IndicatorService {
  ...
  generateRegressionDataset(prices, startDate, endDate, options = {}) {
    ...
    for (let i = 2; i < prices.length - 1; i++) { // Need next-day confirmation data
      ...
      const nextDayClose = prices[nextDayIdx].close;
      const priceChange = nextDayClose - signalClose;
      const priceChangePercent = signalClose > 0 ? ((nextDayClose - signalClose) / signalClose) * 100 : 0;
      ...
      const row = {
        ...
        futureDate: prices[nextDayIdx].date,
        futureClose: parseFloat(nextDayClose.toFixed(2)),
