...
class IndicatorService {
  ...
  getIndicatorsForDate(prices, targetDate, timeframe = 1, horizonDays = 1) {
    ...
    const row = {
      ...
      // RSI 7 Momentum
      rsi7Rising: (prevPrevIdx >= 0 && indicators.rsi7[prevIdx] && indicators.rsi7[prevPrevIdx] &&
        indicators.rsi7[prevIdx] > indicators.rsi7[prevPrevIdx]) ? 1 : 0,
      rsi7ExitOversold: (prevPrevIdx >= 0 && indicators.rsi7[prevIdx] && indicators.rsi7[prevPrevIdx] &&
        indicators.rsi7[prevPrevIdx] < 30 && indicators.rsi7[prevIdx] >= 30) ? 1 : 0,
      rsi7BullishZone: (indicators.rsi7[prevIdx] && indicators.rsi7[prevIdx] >= 30 && indicators.rsi7[prevIdx] <= 50) ? 1 : 0,
      
      // RSI 21 Momentum
      rsi21Rising: (prevPrevIdx >= 0 && indicators.rsi21[prevIdx] && indicators.rsi21[prevPrevIdx] &&
        indicators.rsi21[prevIdx] > indicators.rsi21[prevPrevIdx]) ? 1 : 0,
      rsi21ExitOversold: (prevPrevIdx >= 0 && indicators.rsi21[prevIdx] && indicators.rsi21[prevPrevIdx] &&
        indicators.rsi21[prevPrevIdx] < 30 && indicators.rsi21[prevIdx] >= 30) ? 1 : 0,
      rsi21BullishZone: (indicators.rsi21[prevIdx] && indicators.rsi21[prevIdx] >= 30 && indicators.rsi21[prevIdx] <= 50) ? 1 : 0,
