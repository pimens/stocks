...
const ML_FEATURES = [
  ...
  'macd', 'macdSignal', 'macdHistogram', 'macdBullish', 'macdGoldenCross', 'macdDeathCross', 'macdNearGoldenCross', 'macdHistogramConverging', 'macdHistogramRising', 'macdDistanceToSignal', 'macdCrossUp', 'macdCrossDown',
...
const INDICATOR_GROUPS = {
  ...
  'MACD': ['macd', 'macdSignal', 'macdHistogram', 'deltaMACDHist', 'macdBullish', 'macdGoldenCross', 'macdDeathCross', 'macdNearGoldenCross', 'macdHistogramConverging', 'macdHistogramRising', 'macdDistanceToSignal', 'macdCrossUp', 'macdCrossDown'],
