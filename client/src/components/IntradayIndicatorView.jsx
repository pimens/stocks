...
const ML_FEATURES = [
  ...
  'macd', 'macdSignal', 'macdHistogram', 'macdBullish', 'macdCrossUp', 'macdCrossDown',
...
const INDICATOR_GROUPS = {
  ...
  'MACD': ['macd', 'macdSignal', 'macdHistogram', 'deltaMACDHist', 'macdBullish', 'macdCrossUp', 'macdCrossDown'],
