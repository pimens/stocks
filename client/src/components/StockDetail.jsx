...
import { FiArrowLeft, FiRefreshCw, FiCpu, FiCode, FiChevronDown, FiChevronUp, FiCopy } from 'react-icons/fi'
                  ...
                  <div className="mt-3 space-y-3">
                    <div className="bg-gray-900/70 rounded-lg p-3 border border-gray-700">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() => {
                            navigator.clipboard.writeText(aiAnalysis.prompt.system)
                    ...
                    <div className="bg-gray-900/70 rounded-lg p-3 border border-gray-700">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() => {
                            navigator.clipboard.writeText(aiAnalysis.prompt.user)
                    ...
                    <button
                      onClick={() => {
                        const fullPrompt = `System Prompt:\n${aiAnalysis.prompt.system}\n\nUser Prompt:\n${aiAnalysis.prompt.user}`
